<form class="bg-white shadow-md rounded-lg p-6 w-80" method="POST" action="">
  ...
  <h1 class="text-2xl text-center">Tukar Poin dg Hadiah</h1>
  <label class="text-center block mb-2 text-sm font-medium text-gray-700">
    <?= $pembeli['nama'] ?>
  </label>
  <input required name="nilai" type="text" placeholder="Nama Pelanggan" value="<?= $pembeli['poin'] ?>"
